...
Not just that, once the attackers control any browser extension, Avast Antivirus makes it easy for them to escape the browser. In the worst case scenario they will be able to install malware or ransomware in the user's account. This vulnerability is still open for any malicious or compromised browser extension to exploit, from any browser.
