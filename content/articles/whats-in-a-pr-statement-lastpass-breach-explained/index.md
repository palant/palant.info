...
Again, it seems that LastPass attempts to minimize the risk of litigations (hence alerting business) while also trying to prevent a public outcry (so not notifying the general public). Priorities…